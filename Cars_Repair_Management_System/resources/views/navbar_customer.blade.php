       ...
       <div class="container-fluid">
         ...
         <div class="collapse navbar-collapse" id="myNavbar">
           <ul class="nav navbar-nav gabali">
             <li><h5><h4><font color="skyblue"><b>C</b>ar Repair Management System</font></h4></a></li>
             <li><a href="#"></a></li>
             <li><a href="index">Home</a></li>
             <li><a href="customer_request_machanics">Request Mechanics</a></li>
             <li><a href="customer_view_response">View Response</a></li>
           ...
           <ul class="nav navbar-nav navbar-right">
             ...
             <li><a href="#"><span class="glyphicon glyphicon-log-in"></span> Contact Us<?php //echo $_SESSION['username']; ?></a></li>
           </ul>
         </div> 
